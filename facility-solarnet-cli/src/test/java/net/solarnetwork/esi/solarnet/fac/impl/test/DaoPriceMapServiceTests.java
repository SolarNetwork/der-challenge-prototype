...
public class DaoPriceMapServiceTests {
  ...
  public void receivePriceMapOffer_AcceptedFromMultiple() {
    ...
    FacilityPriceMap facPriceMapReject = new FacilityPriceMap(UUID.randomUUID().toString(),
        offerPriceMap.copy());
    ...
    FacilityPriceMap facPriceMapOk = new FacilityPriceMap(UUID.randomUUID().toString(),
        offerPriceMap.copy());
  ...
  public void receivePriceMapOffer_CounteredByPrice() {
    ...
    FacilityPriceMap facPriceMapExtort = new FacilityPriceMap(UUID.randomUUID().toString(),
        offerPriceMap.copy());
