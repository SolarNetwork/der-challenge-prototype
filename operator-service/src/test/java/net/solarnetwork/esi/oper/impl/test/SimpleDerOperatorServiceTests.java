...
package net.solarnetwork.esi.oper.impl.test;
...
import net.solarnetwork.esi.oper.impl.SimpleDerOperatorService;
import net.solarnetwork.esi.service.DerOperatorServiceGrpc;
import net.solarnetwork.esi.service.DerOperatorServiceGrpc.DerOperatorServiceBlockingStub;

/**
 * Test cases for the {@link SimpleDerOperatorService} class.
 * 
 * @author matt
 * @version 1.0
 */
public class SimpleDerOperatorServiceTests {
  ...
  private SimpleDerOperatorService service;
  ...
  public void setUp() throws Exception {
    ...
    service = new SimpleDerOperatorService(operatorUid, registrationForms);
  ...
  public void registrationFormForLang() {
    // given
    DerOperatorServiceBlockingStub client = DerOperatorServiceGrpc.newBlockingStub(channel);
